...
<meta charset="UTF-8">
    ...
    <title>Employment Classification</title>
</head>
<body>
<header>
  <?php
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Classification</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form action="Data Controller/Classification/classification_conn.php" method="POST">
      <div class="modal-body">
        <div class="mb-3">
            <label for="exampleInputText" class="form-label">Classification</label>
            <input name="classification" type="text" class="form-control" id="date_input" required>
        </div>
...
<div class="modal fade" id="editmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="actions/Classification/update_data.php" method="POST">
      <div class="modal-body">
        ...
        <div class="mb-3">
            <label for="exampleInputText" class="form-label">Classification</label>
            <input name="classification" id="update_position" type="text" class="form-control" required>
        </div>
...
<div class="modal fade" id="deletemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="actions/Classification/delete.php" method="POST">
      <div class="modal-body">

        <input type="hidden" name="delete_id" id="delete_id">
        <input type="hidden" name="classification" id="designate">
...
<div class="main-panel mt-5" style="width: 100%; height: 100vh; position: absolute; top: 6px; margin-left: 16.8%;">
        <div class="content-wrapper mt-5">
          <div class="card">
            ...
            <div class="row">
                        <div class="col-6">
                            <h2 style="font-size: 27px; font-weight: bold">Employment Classification</h2>
                        </div>
                    ...
                    <div class="table-responsive" style="overflow: hidden;">
                      ...
                      <input type="hidden" id="table_id_position" name="id">
                        ...
                        <thead style="background-color: #ececec;">
                            ...
                            <th>Employement Classification</th>
                            <th>Designation</th>
                            <th>Action</th>
                            </tr>
                        </thead>
                        ...
                        <?php
                                ...
                                $dept_query = "SELECT id, classification FROM classification_tb";
                                ...
                                while ($dept_row = mysqli_fetch_assoc($dept_result)) {
                                    $pos_id = $dept_row['id'];
                                    $pos_name = $dept_row['classification'];
                                    $emp_query = "SELECT COUNT(*) as count FROM employee_tb WHERE classification = '$pos_id'";
