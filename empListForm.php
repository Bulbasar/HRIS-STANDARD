                        ...
                        <div class="employeeList-empAccess-container hide-element">
                            ...
                            <div class="emp-Access-second-input " style="width: 94%">
                                ...
                                <div class="emp-Access-email">
                                        ...
                                        <input pattern="[A-Za-z0-9._+-]+@[A-Za-z0-9.-]+\.[a-z]{2,}"  type="text" name="comp_email" id="form-emails" placeholder="Email Address" title="Must be a valid email."  value="<?php echo $row_setting['email_domain']?>">
                                </div>
                                <div class="">
