...
<a href=""></a>
            ...
            <?php
                    ...
                    if(isset($_POST['view_data_Pay'])){

                        $pay_id = $_POST['name_rulename'];
                        $pay_view = $_POST['name_payname'];
                            ...
                            <div class='row' style='margin-top: 20px; margin-left:5px; margin-right:5px;'>
                                ...
                                <div class='col-6 text-end' style=''>
                                    <a href='Payrules.php' class='btn btn-outline-danger'>Back</a>
                                </div> <!--sec col-6 end-->
                            </div> <!--row end-->
                                ...
                                <div class='table my-3 table-responsive '>
                                    <table id='order-listing' class='table table-sortable table-hover caption-top'>
                                        ...
                                        <tbody>";
                                                ...
                                                $dept_query = "SELECT Payrule_tb.id,
                                                                        employee_tb.empid,
                                                                        CONCAT(
                                                                            employee_tb.`fname`,
                                                                            ' ',
                                                                        ...
                                                                        Payrule_tb.rule_name FROM employee_tb INNER JOIN Payrule_tb ON employee_tb.payrules = Payrule_tb.id 
                                                                      WHERE employee_tb.payrules = '$pay_id'";
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                  ...
                                                  $sql = "SELECT employee_tb.company_code, 
                                                    ...
                                                    echo "</td>
                                                        ...
                                                        <td style='font-weight:400'>" . $row['rule_name'] . "</td>
