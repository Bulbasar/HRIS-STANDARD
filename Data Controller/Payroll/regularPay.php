                                    ...
                                    *
                                    ...
                                    if($day_of_validHoliday === 'Monday')
                                            ...
                                            if($row_Sched['mon_timein'] == NULL || $row_Sched['mon_timein'] == '')
                                            {
                                                ...
                                                if(mysqli_num_rows($result_restDay_worked) > 0)
                                                {
                                                    ...
                                                    $double_pay_holiday_initial =  ($daily_rate * 2) * 1.3;
                                                     ...
                                                     $double_pay_holiday_restday +=  $double_pay_holiday_ + $double_pay_holiday_initial;
                                                }
                                                ...
                                                if(mysqli_num_rows($result_holiday_OT_restday) > 0) {
                                                    ...
                                                    $totalOT_pay_holiday_restday += $emp_OtRate * 2 * 1.3 * 1.3 * $OT_totalHour_restday; //if has worked and overtime in Holiday
                                        ...
                                        //-------------------------Para sa nag OVERTIME ang employee sa holdiday RESTDAY END----------------------
                                                ...
                                                $double_pay_holiday += ($daily_rate + $allowances) * 2; //if holiday and worked
                                                ...
                                                if(mysqli_num_rows($result_holiday_OT) > 0) {
                                                    ...
                                                    $totalOT_pay_holiday += $emp_OtRate * 2 * 1.3 * $OT_totalHour; //if has worked and overtime in Holiday
