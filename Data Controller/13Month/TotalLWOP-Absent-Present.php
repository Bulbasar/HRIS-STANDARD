...
$AbsentDeduction = $EmpDrate * $TotalAbsent; //Para sa modal na deduction
...
$LWOPDeduction = $EmpDrate * $TotalLWOP; //Para sa modal na deduction
...
$LeavewithPay = $EmpDrate * $TotalLeavePaid;
