...
<a href=""></a>
            ...
            <?php
                    ...
                    if(isset($_POST['view_data'])){
                        ...
                        $emp_position = $_POST['classification'];
                        $position_id = $_POST['id'];
                            ...
                            <div class='row' style='margin-top: 20px; margin-left:5px; margin-right:5px;'>
                                ...
                                <div class='col-6 text-end' style=''>
                                    <a href='Classification' class='btn btn-outline-danger'>Go back</a>
                                </div> <!--sec col-6 end-->
                            </div> <!--row end-->
                                ...
                                <div class='table my-3 table-responsive '>
                                    <table id='order-listing' class='table table-sortable table-hover caption-top'>
                                        ...
                                        <tbody>";
                                                ...
                                                $pos_query = "SELECT classification_tb.id,
                                                                employee_tb.empid,
                                                                CONCAT(
                                                                    employee_tb.`fname`,
                                                                    ' ',
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                  ...
                                                  $sql = "SELECT employee_tb.company_code, 
                                                    ...
                                                    echo "</td>
                                                        ...
                                                        <td style='font-weight:400'>" . $row['classification'] . "</td>
