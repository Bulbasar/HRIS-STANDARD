...
<body>
    ...
    <div class="loan-req-form-container">
        ...
        <div class="row" style="width:92%; margin: auto;">
            <div class="col-6 mt-4" style="padding: 0 30px 0 30px;">  
                <div class="form-group">
                    ...
                    <select name="empid" id="" class="form-select" style="height:50px;" required > 
                ...
                <div class="form-group loan-remarks">
                    ...
                    <textarea name="remarks" id="" rows="7" class="form-control" title="Remarks"></textarea>
                </div>
            </div>
            <div class="col-6" style="padding: 0 30px 0 30px;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="payable_amount" class="form-control" style="height:50px; text-decoration: none;" id="payable_amount" oninput="calculate()" required placeholder="Enter Amount"> 
                </div>
                <style>
